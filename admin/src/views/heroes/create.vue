                ...
                <el-tab-pane label="基本信息">
                    ...
                    <el-form-item label="头像">
                        <el-upload
                            ...
                            :action="uploadUrl"
                            :on-success="res => $set(info, 'avatar', res.url)"
                            :show-file-list="false"
                        >
